...
class PhotoGalleryController extends Controller
{
    ...
    public function store(Request $request, ?int $id = null)
    {
        ...
        if ($id != null) {
            ...
            //user edit section is hare
                ...
                return redirect()->route('admin.photogallery',['id'=>$id,'page'=>request()->query('page'),'search'=>request()->query('search')])->with('success','Successfully edited');
            }catch(Exception $e){
    ...
    public function destory(int $id)
    {
        ...
        return redirect()->route('admin.photogallery')->with('success', 'Successfully Delete');
        }catch(Exception $e){
            Log::error("this message is from : ".__CLASS__."Line is : ".__LINE__." messages is ".$e->getMessage());
            return redirect()->route('error');
        }
